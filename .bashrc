...
export OSH='/home/ylwu/.oh-my-bash'
...
alias compose='docker-compose pull && docker-compose up'
alias remove='docker rm -f $(docker ps -qa)'
alias dangle='docker rmi $(docker images -f "dangling=true" -q)'
alias dip='docker image prune'
alias wk='cd /home/ylwu/Documents/Triple%20-%20LS'
...
alias e2e='docker exec one-app-api-dev npm run build:e2e && docker exec one-app-api-dev npm run test:e2e'
